    ...
    <>
      ...
      <div className='bg-gray-100'>
          ...
          <div className=' py-[6%] pl-[12%]'>
            ...
            <h1 className='text-3xl font-bold pb-5'>Search Result Not Found</h1>
            <Breadcrumbs>
...
{/* {data?.products && <div className='mt-6 mx-[11%] pb-10'>

<h1 className='text-5xl font-semibold  pt-10'>{searchProduct}</h1>
...
<div className='grid grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-8'>
  ...
  {data?.products && data?.products.map((mealdata,index)=>{
    return (
        <div className='pt-10' key={`${mealdata?.id}`} onClick={()=>nav(`/product_details/${mealdata?.id}`)}>
         ...
         <h1 className='text-xl text-center font-bold pt-5'>{`${mealdata?.title}`}</h1>
